...
class PeopleFactory(object):
    ...
    def __init__(self):
        ...
        self.young_age_lbound = 18
        self.young_age_ubound = 22
        self.older_age_mean = 20
    ...
    def choose_age(self):
        ...
        if agegrp == 'young':
            age = random.uniform(self.young_age_lbound 
                                 
                                 , self.young_age_ubound)
        elif agegrp == 'older':
...
class Student(Person):
    def __init__(self, name, sex, age, height, grade = 0.0):
        Person.__init__(self, name, sex, age, height)
